...
public class TFTPServer
{
    ...
    public static final String IPADDRESS = "192.168.31.1";
    ...
    public void start() throws IOException
    {
        ...
        /*Traducir el String IPADDRESS a un InetSocketAddress*/
        InetAddress ipAddress = InetAddress.getByName(IPADDRESS);

        /* Create local bind point*/
        SocketAddress localBindPoint= new InetSocketAddress(ipAddress,TFTPPORT);
        System.out.println(localBindPoint);
     ...
     */
    public InetSocketAddress receiveFrom(DatagramSocket socket, byte[] buf) throws IOException
    {
     ...
     */
    public int ParseRQ(byte[] buf, StringBuffer requestedFile, StringBuffer mode)
    {
        /*wrap the byte array*/
     ...
     */
    public void HandleRQ(DatagramSocket sendSocket, String requestedFile, int opcode, InetSocketAddress clientAddress) throws IOException
    {
        if(opcode == OP_RRQ)
        {
    ...
    public boolean send_DATA_receive_ACK( DatagramSocket sendSocket, byte[] bufSend, InetSocketAddress clientAddress, int length, short block) throws IOException
    {
    ...
    public int receive_DATA_send_ACK(DatagramSocket sendSocket, InetSocketAddress clientAddress, OutputStream stream, short previousblock) throws IOException
    {
    ...
    public void send_ERR(DatagramSocket sendSocket,short errorNumber, String errorMessage) throws IOException
    {
     ...
     */
    public short getShort(byte[] buf, int position)
    {
        ByteBuffer wrap= ByteBuffer.wrap(buf);
    ...
    public void createAck(byte[] buf, short opcode, short block)
    {
        ByteBuffer wrap = ByteBuffer.wrap(buf);
